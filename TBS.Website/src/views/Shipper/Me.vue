<template>
  <div class="container pt-5 pb-5">
    <WideFormCard title="Update Information" :submit="submit">

      <div slot="card-content" class="text-center">
        <ul class="nav nav-tabs nav-justified mb-2" role="tablist">
          <li class="nav-item">
            <a class="nav-link" href="" data-toggle="tab" role="tab" aria-controls="shipper"></a>
          </li>
        </ul>
        ...
        <button class="btn btn-main btn-lg bg-blue fade-on-hover btn-block text-uppercase text-white" type="submit">Upate</button>
      </div>
    </WideFormCard>
  </div>
</template>
